...
# Simple script providing a useful reference to the periodic table of elements
...
elements = [
    ('n', 'Neutronium'),  # Not quite legitimate...
    ('H', 'Hydrogen'),
    ('He', 'Helium'),
    ('Li', 'Lithium'),
    ('Be', 'Beryllium'),
...
for arg in sys.argv[1:]:
    ...
    try:
        ...
        for Z in xrange(len(elements)):
            ...
            # Check for match with name or symbol
            if elements[Z][0] == string or elements[Z][1] == string:
                found = True
    ...
    # This isn't a usable proton number
    if not 0 <= Z <= 118:
